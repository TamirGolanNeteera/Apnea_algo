...
import time as time
from Tests.NN.nn_models import increment_resnet_model_late_batchnorm, large_resnet_model_late_batchnorm, small_resnet_model_late_batchnorm
...
if __name__ == '__main__':
    ...
    for k_fold_test_subject in subjects_to_run_on:
        ...
        model = increment_resnet_model_late_batchnorm(input_shape)
        model.summary()
