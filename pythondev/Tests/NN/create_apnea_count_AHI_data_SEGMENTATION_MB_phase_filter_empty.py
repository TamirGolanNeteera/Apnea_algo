...
from Tests.NN.create_apnea_count_AHI_data import MB_HQ, getSetupRespirationCloudDB
...
#  110044, 110045, 110071, 110072, 110190, 110191]
...
def create_AHI_segmentation_training_data_MB_phase(respiration, apnea_ref, empty_seconds, time_chunk, step, scale, fs):
    print("in")
    X = []
    y = []
    valid = []
...
if __name__ == '__main__':
    ...
    for i_sess, sess in enumerate(setups):
        ...
        try:
            ...
            empty_ref_mb = None
            X, y, valid = create_AHI_segmentation_training_data_MB_phase(respiration=respiration,
