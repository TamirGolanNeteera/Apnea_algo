...
import random
import time as time
from Tests.NN.transformer_1d import create_vit_1d
...
if __name__ == '__main__':
    ...
    setups_to_run_on = rsetups[gpu_id, :]
    ...
    for k_fold_test_setup in setups_to_run_on:
        ...
        if len(sig.shape) == 1:
            input_shape = (sig.shape[0], 1)


        model = create_vit_1d(input_shape)#large_resnet_model_late_batchnorm_1D(input_sig_shape)
