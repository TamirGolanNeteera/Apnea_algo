...
from Tests.NN.create_apnea_count_AHI_data import getSetupRespirationLocalDBReversePreprocessing, create_AHI_training_data, create_AHI_training_data_no_wake_no_empty, count_apneas_in_chunk, getApneaSegments, getWakeSegments, getSetupRespiration
...
if __name__ == '__main__':
    ...
    """use to display signal thenexit"""
    ...
    for i_sess, sess in enumerate(setups):
        ...
        if args.overwrite and os.path.isfile(os.path.join(args.save_path, str(sess) + '_X.npy')):
