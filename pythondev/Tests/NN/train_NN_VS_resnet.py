...
if __name__ == '__main__':
    ...
    if False:
        ...
        np.save(os.path.join(args.save_path, "ys.npy"), ys, allow_pickle=True)
        with open(os.path.join(args.save_path, "file_dict.pkl"), 'wb') as fp:
            pickle.dump(file_dict, fp)
        with open(os.path.join(args.save_path, "mean_dict.pkl"), 'wb') as fp:
            pickle.dump(mean_dict, fp)
        print('dictionary saved successfully to file')
    else:
        ys = np.load(os.path.join(args.save_path, "ys.npy"), allow_pickle=True)
        with open(os.path.join(args.save_path, "file_dict.pkl"), 'rb') as fp:
            file_dict = pickle.load(fp)
        with open(os.path.join(args.save_path, "mean_dict.pkl"), 'rb') as fp:
    ...
    # test the NN
        ...
        if args.test:
            ...
            for i,setup_of_ds in enumerate(test_sessions):
                ...
                # print(np.stack(y_true).flatten())
                # print(np.stack(y_pred).flatten())
