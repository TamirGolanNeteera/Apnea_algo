    ...
    for k_fold_test_setup in [1]:
        ...
        if args.mode == 'train':
           ...
           # radar_setups_all = db.setups_by_session(main_session)
            ...
            if args.reload:
                try:
                    train_path = '/Neteera/Work/homes/dana.shavit/Research/apnea2021/trained_nns/nn_regression_1708_test_mb_40_unscaled_filter_wake/checkpoints/'
                    json_fn = '109816model.json'
                    weights_fn = '109816_model.hdf5'
        ...
        for setup_of_subject in MB_HQ:
            ...
            if db.mysql_db == 'neteera_cloud_mirror': #MB
                ...
                data_test, labels_test, valid = create_AHI_regression_training_data_MB_chest_fs(respiration=respiration,
            ...
            res[setup_of_subject] = [np.round(m_AHI_gt,1), np.round(m_AHI_pred,1)]
