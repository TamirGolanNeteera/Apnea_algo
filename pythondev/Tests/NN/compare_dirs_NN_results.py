...
lp = ['/Neteera/Work/homes/dana.shavit/Research/BP2023/trained_nns/190323_5sec_huber/',
      '/Neteera/Work/homes/dana.shavit/Research/BP2023/trained_nns/200323_15sec/',
...
for i, setup in enumerate(setups):
    ...
    # if mean_gt1 > 180 or mean_gt1 < 100:
    #     print(setup, "mean gt", mean_gt1, "skipping")
    #     continue
    ...
    #         marker='o'
        ...
        m_pred2 = preds_avg2[gt1 == m]
        m_loss1 = np.mean(np.abs(m_gt1 - m_pred1))
        m_loss2 = np.mean(np.abs(m_gt1 - m_pred2))
