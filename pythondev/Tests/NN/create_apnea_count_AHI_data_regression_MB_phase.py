...
from Tests.NN.create_apnea_count_AHI_data import count_apneas_in_chunk, getSetupRespirationCloudDB
...
if __name__ == '__main__':
    ...
    for i_sess, sess in enumerate(setups):
        ...
        try:
            ...
            X, y, valid = create_AHI_regression_training_data_MB_chest_fs(respiration=respiration,
