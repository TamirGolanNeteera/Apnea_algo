...
import time as time
from Tests.NN.nn_models import small_vgg_model, large_vgg_model_late_batchnorm, build_transformer_model, CnnTransformerModel, MyCnnTransformerModel
from Tests.NN.transformer import multiple_transformer
...
if __name__ == '__main__':
    ...
    for k_fold_test_setup in setups:
        ...
        checkpointer = ModelCheckpoint(save_weights_only=True,filepath=train_path + '/checkpoints/' + sname + '_model.hdf5', verbose=1,save_best_only=True)
