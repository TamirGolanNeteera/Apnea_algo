...
from keras.layers import Conv2D, MaxPool2D, Conv1D, GRU, LSTM,  Bidirectional, MaxPool1D, BatchNormalization, Dropout, Activation, add,GlobalAveragePooling1D
...
def my_balanced_high_ahi_oversampling_generator(data_dict, batchsize):
    while 1:
        x_out = []
        y_out = []
    ...
    for k_fold_test_setup in all_setups:
        ...
        if True:
           ...
           # print("val", val_sessions)
            ...
            input_layer = Input(input_sig_shape)
            ...
            output = Dense(1, activation='relu')(gap_layer)
