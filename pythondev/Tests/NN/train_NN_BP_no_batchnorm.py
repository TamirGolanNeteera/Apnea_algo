...
import time as time
from Tests.NN.nn_models import small_vgg_model, large_vgg_model_late_batchnorm, large_vgg_model_no_batchnorm
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('-gpu', metavar='seed', type=int, required=False, help='Gpu device id')
