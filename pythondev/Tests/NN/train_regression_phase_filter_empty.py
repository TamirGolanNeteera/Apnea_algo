...
from Tests.NN.create_apnea_count_AHI_data import create_AHI_training_data_no_wake_no_empty
from Tests.NN.create_apnea_count_AHI_data_regression_MB_phase_filter_empty import create_AHI_regression_training_data_MB_phase, load_apnea_ref_from_annotations, create_AHI_regression_training_data_from_annotation, apnea_class, get_empty_seconds_mb
...
if __name__ == '__main__':
    ...
    mb_setups = [109870, 109872, 109877, 109884, 109886, 109887, 109889, 109892, 109897,
