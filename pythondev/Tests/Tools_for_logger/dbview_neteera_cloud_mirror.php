...
$empSQL = "SELECT Session, Setup, Timestamp, Duration, Path, Company, Operator, Subject, Posture, Scenario, Location, Target, State,
       CONCAT_WS(', ', GT_POS, GT_NEG) AS GT, FW, Model, Distance, SN, Version, Validity, Notes, Legacy
